        ...
        <ModalStyle {...rest}>
            ...
            <Wrapper>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignSelf: 'center' }}>
                    ...
                    <Link href={rest.content.gift} target="_blank">
                        <Text style={{ display: 'inline' }}>Github 바로가기</Text>
                    </Link>
                    {rest.content.site ? (
                        <Link style={{ marginTop: 0 }} href={rest.content.site1} target="_blank">
            ...
            {rest.content.ios ? (
                <Link href={rest.content.ios} target="_blank">
                    <img style={{ width: 200, marginLeft: 20 }} src={require('../../assets/images/ios.png')}></img>
                </Link>
            ) : (
                ''
            )}
