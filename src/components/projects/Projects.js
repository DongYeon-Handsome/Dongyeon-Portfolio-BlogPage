...
const Projects = {
  ...
  플랜다이얼: {
    ...
    felt: '직접 기획에 참여한 프로젝트입니다. 처음 안드로이드 Java를 사용해 개발을 하고 스토어에 출시한 다음 사용자들의 피드백을 받아 처음 기획했을 때 구현했던 앱 UI/UX의 투박함, 또한 Main 화면에 있는 이 어플의 핵심이라 생각했던 메인 다이얼이 오히려 불편하다는 피드백을 받아 디자인을 다시 설계하고 안드로이드만 지원한다는 단점을 극복하기 위해 Flutter 기반 Cross-Platform으로 앱을 다시 리뉴얼하는 버전2 프로젝트에 기획으로 참여했습니다.',
  },
  웹사이트: {
    img: Icons[3].src,
